...
/**
 * Request pour la mise à jour d'un employé
 */
class UpdateEmployeeRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('iban')) {
            $this->merge(['iban' => strtoupper(str_replace(' ', '', $this->iban))]);
        }
    }
    ...
    {
        $userId = $this->route('employee')?->id ?? $this->route('user')?->id;
        ...
        return [
            ...
            'date_embauche' => 'sometimes|required|date|before_or_equal:today',
